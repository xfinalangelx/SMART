...
export default function BloodSugarGraphScreen() {
  ...
  const handleAddData = async () => {
    ...
    try {
      await dispatch({ type: 'ADD_BLOOD', payload: dataPoint });
  ...
  const graphData = state?.appData?.graphData?.bloodSugar || [];
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <Text style={styles.title}>{language === 'bm' ? 'Gula Darah' : 'Blood Sugar'}</Text>

          <Text style={styles.description}>
            {language === 'bm'
              ? 'Jejaki paras gula dalam darah anda.'
                            ...
                            Alert.alert(
                              ...
                              [
                                { text: language === 'bm' ? 'Batal' : 'Cancel', style: 'cancel' },
                                {
                                  ...
                                  style: 'destructive',
                                  onPress: () => {
                                    dispatch({ type: 'DELETE_BLOOD_SUGAR', payload: actualIndex });
                                  },
                                },
                              ]
                            );
          ...
          {!showAddForm && (
            <TouchableOpacity style={styles.addButton} onPress={() => setShowAddForm(true)}>
              <LinearGradient colors={['#E91E63', '#F06292']} style={styles.addButtonGradient} start={[0, 0]} end={[1, 0]}>
          ...
          {showAddForm && (
            <View style={styles.addForm}>
              ...
              <TouchableOpacity style={styles.dateButton} onPress={() => setShowDatePicker(true)}>
                <Ionicons name="calendar-outline" size={20} color="#E91E63" style={{ marginRight: 8 }} />
              ...
              <TextInput
                style={styles.input}
                placeholder={language === 'bm' ? 'Nilai Gula Darah (cth: 5.5)' : 'Blood Sugar Value (e.g: 5.5)'}
                value={newValue}
              ...
              <View style={styles.formButtons}>
                ...
                <TouchableOpacity style={[styles.formButton, styles.saveButton]} onPress={handleAddData}>
                  <LinearGradient colors={['#E91E63', '#F06292']} style={styles.saveButtonGradient} start={[0, 0]} end={[1, 0]}>
