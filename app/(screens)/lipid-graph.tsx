...
export default function LipidGraphScreen() {
  ...
  const handleAddData = async () => {
    ...
    try {
      await dispatch({ type: 'ADD_LIPID', payload: dataPoint });
      ...
      console.error('Error adding lipid data:', error);
      Alert.alert(
        language === 'bm' ? 'Ralat' : 'Error',
  ...
  const graphData = state?.appData?.graphData?.lipid || [];
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <Text style={styles.title}>{language === 'bm' ? 'Profil Lipid' : 'Lipid Profile'}</Text>

          <Text style={styles.description}>
            {language === 'bm'
              ? 'Jejaki paras kolesterol anda.'
                  ...
                  return (
                    <View key={reverseIndex} style={styles.dataItem}>
                      <View style={styles.dataInfo}>
                        ...
                        <Text style={styles.dataValue}>{item.value} mmol/L</Text>
                      </View>
                            ...
                            Alert.alert(
                              ...
                              [
                                { text: language === 'bm' ? 'Batal' : 'Cancel', style: 'cancel' },
                                {
                                  ...
                                  style: 'destructive',
                                  onPress: () => {
                                    dispatch({ type: 'DELETE_LIPID', payload: actualIndex });
                                  },
                                },
                              ]
                            );
          ...
          {!showAddForm && (
            <TouchableOpacity style={styles.addButton} onPress={() => setShowAddForm(true)}>
              <LinearGradient colors={['#FF9800', '#FFB74D']} style={styles.addButtonGradient} start={[0, 0]} end={[1, 0]}>
          ...
          {showAddForm && (
            <View style={styles.addForm}>
              ...
              <TouchableOpacity style={styles.dateButton} onPress={() => setShowDatePicker(true)}>
                <Ionicons name="calendar-outline" size={20} color="#FF9800" style={{ marginRight: 8 }} />
              ...
              <TextInput
                style={styles.input}
                placeholder={language === 'bm' ? 'Nilai Lipid (cth: 5.2)' : 'Lipid Value (e.g: 5.2)'}
                value={newValue}
              ...
              <View style={styles.formButtons}>
                ...
                <TouchableOpacity style={[styles.formButton, styles.saveButton]} onPress={handleAddData}>
                  <LinearGradient colors={['#FF9800', '#FFB74D']} style={styles.saveButtonGradient} start={[0, 0]} end={[1, 0]}>
